...
class VideoResourceIT {
    ...
    public static Video createEntity(EntityManager em) {
        Video video = new Video().url(DEFAULT_URL).descripton(DEFAULT_DESCRIPTON).title(DEFAULT_TITLE);
        return video;
    }
    ...
    public static Video createUpdatedEntity(EntityManager em) {
        Video video = new Video().url(UPDATED_URL).descripton(UPDATED_DESCRIPTON).title(UPDATED_TITLE);
        return video;
    }
    ...
    void putNewVideo() throws Exception {
        ...
        updatedVideo.url(UPDATED_URL).descripton(UPDATED_DESCRIPTON).title(UPDATED_TITLE);
    ...
    void fullUpdateVideoWithPatch() throws Exception {
        ...
        partialUpdatedVideo.url(UPDATED_URL).descripton(UPDATED_DESCRIPTON).title(UPDATED_TITLE);
