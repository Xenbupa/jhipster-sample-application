...
class VideoResourceIT {
    ...
    private static final Integer DEFAULT_VIDEO_SIZE = 1;
    private static final Integer UPDATED_VIDEO_SIZE = 2;
    ...
    public static Video createEntity(EntityManager em) {
        Video video = new Video().url(DEFAULT_URL).descripton(DEFAULT_DESCRIPTON).title(DEFAULT_TITLE).videoSize(DEFAULT_VIDEO_SIZE);
        return video;
    }
    ...
    public static Video createUpdatedEntity(EntityManager em) {
        Video video = new Video().url(UPDATED_URL).descripton(UPDATED_DESCRIPTON).title(UPDATED_TITLE).videoSize(UPDATED_VIDEO_SIZE);
        return video;
    }
    ...
    void createVideo() throws Exception {
        ...
        assertThat(testVideo.getDescripton()).isEqualTo(DEFAULT_DESCRIPTON);
    ...
    void getAllVideos() throws Exception {
        ...
        restVideoMockMvc
            ...
            .andExpect(jsonPath("$.[*].descripton").value(hasItem(DEFAULT_DESCRIPTON)))
    ...
    void getVideo() throws Exception {
        ...
        restVideoMockMvc
            ...
            .andExpect(jsonPath("$.descripton").value(DEFAULT_DESCRIPTON))
    ...
    void putNewVideo() throws Exception {
        ...
        updatedVideo.url(UPDATED_URL).descripton(UPDATED_DESCRIPTON).title(UPDATED_TITLE).videoSize(UPDATED_VIDEO_SIZE);
        ...
        assertThat(testVideo.getDescripton()).isEqualTo(UPDATED_DESCRIPTON);
    ...
    void partialUpdateVideoWithPatch() throws Exception {
        ...
        partialUpdatedVideo.descripton(UPDATED_DESCRIPTON);
    ...
    void fullUpdateVideoWithPatch() throws Exception {
        ...
        partialUpdatedVideo.url(UPDATED_URL).descripton(UPDATED_DESCRIPTON).title(UPDATED_TITLE).videoSize(UPDATED_VIDEO_SIZE);
