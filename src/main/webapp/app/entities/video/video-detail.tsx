    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="descripton">
              <Translate contentKey="jhipsterSampleApplicationApp.video.descripton">Descripton</Translate>
            </span>
          </dt>
          <dd>{videoEntity.descripton}</dd>
          <dt>
            <span id="title">
          ...
          <dt>
            <Translate contentKey="jhipsterSampleApplicationApp.video.video">Video</Translate>
          </dt>
          <dd>{videoEntity.video ? videoEntity.video.title : ''}</dd>
        </dl>
