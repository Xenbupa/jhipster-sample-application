...
export const VideoUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const saveEntity = values => {
    const entity = {
      ...videoEntity,
      ...values,
      video: users.find(it => it.id.toString() === values.video.toString()),
    };
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationApp.video.descripton')}
                id="video-descripton"
                name="descripton"
                data-cy="descripton"
                type="text"
              ...
              <ValidatedField
                ...
                name="video"
                data-cy="video"
                label={translate('jhipsterSampleApplicationApp.video.video')}
                type="select"
              >
                <option value="" key="0" />
                {users
